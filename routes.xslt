...
>
	...
	<xsl:template mode="route:widget" match="px:Route/@*|px:Routes/@*">
		<xsl:param name="xo:context" select="node-expected"/>
		<xsl:variable name="route" select="current()"/>
		<xsl:element name="a">
			<xsl:attribute name="xo-slot"></xsl:attribute>
	...
	<xsl:template name="route:link-attribute" mode="route:link-attribute" match="px:Route/@*|px:Routes/@*" priority="-1">
		...
		<xsl:variable name="method">
			<xsl:choose>
				<xsl:when test="parent::px:Routes">edit</xsl:when>
	...
	<xsl:template mode="menu:item-link-attribute" match="px:Route[@Method='edit']/@*|px:Routes/@*" priority="-1">
	...
	<xsl:template mode="route:item-icon" match="px:Route[@Method='edit']/@*|px:Routes/@*" priority="-1">
	...
	<xsl:template mode="route:widget-button" match="px:Route[@Method='edit']/@*|px:Routes/@*" priority="-1">
		<xsl:param name="xo:context" select="node-expected"/>
		<xsl:for-each select="$xo:context[self::px:Entity or self::data:rows or self::xo:r]">
